...
namespace Maper
{
    public partial class Relationship : Form
    {
        ...
        {
            InitializeComponent();
            //设置comboBoxMethod的选择项
            comBoxMethod.Items.Add("Intersect");
            comBoxMethod.Items.Add("Whithin");
            comBoxMethod.Items.Add("Contain");
            comBoxMethod.Items.Add("Touches");
            comBoxMethod.Items.Add("Cross");
            comBoxMethod.Items.Add("EnvelopeIntersct");
            comBoxMethod.Items.Add("Overlap");
        }

        private void Relationship_Load(object sender, EventArgs e)
        {
            try
            {
                //清空目标图层列表
        ...
        {
            IActiveView pActiveView = (IActiveView)currentMap;
        ...
        private void SelectFeaturesBySpatial()
        {
            ...
            spatialFilter.Geometry = GetFeatureLayerGeometryUnion
                (GetFeatureLayerByName(currentMap, comBoxSourceLayer.SelectedItem.ToString()));
